 ...
 * request) and post-processing (returning response) for a request to a Servlet
 * need login.
 *
 * Bugs: None
 *
...
public class FilterForLogin implements Filter {
     ...
     * response) for a request to a Servlet need login. Throw the
     ...
     * client's web browser. It is a <code>javax.servlet.ServletResponse</code>;
